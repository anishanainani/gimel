...
object GenericDeserializerConfigs {
  ...
  val avroSchemaSourceKey: String = "gimel.serde.avro.schema.source"
  val avroSchemaSourceUrlKey: String = "gimel.serde.avro.schema.url"
  val avroSchemaSubjectKey: String = "gimel.serde.avro.schema.subject"
  val avroSchemaStringKey: String = "gimel.serde.avro.schema.string"
  val columnToDeserializeKey: String = "gimel.serde.column.name"
