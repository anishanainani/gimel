...
object GimelJsonProtocol extends DefaultJsonProtocol {
  ...
  implicit val storageSystemDiscoveryPayload: RootJsonFormat[StorageSystemDiscovery] = jsonFormat9(StorageSystemDiscovery)
  implicit  val storageSystemPostPayLoad: RootJsonFormat[StorageSystemPostPayLoad] = jsonFormat14(StorageSystemPostPayLoad)
