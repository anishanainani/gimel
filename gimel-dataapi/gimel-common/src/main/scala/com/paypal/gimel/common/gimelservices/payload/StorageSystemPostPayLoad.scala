...
case class StorageSystemPostPayLoad (
                                      storageSystemDescription: String = ""
                                    , createdUser: String = "gimel_admin"
                                    , storageSystemName: String = ""
                                    , updatedUser: String = ""
                                    , containers: String = "All"
                                    , storageTypeId: Int = -99
                                    , adminUserId: Int = -99
                                    , assignedClusterId: Int = -99
                                    , runningClusterId: Int = -99
                                    , zoneId: Int = -99
                                    , isGimelCompatible: String = "N"
                                    , isReadCompatible: String = ""
                                    , discoverySla: String = "60"
